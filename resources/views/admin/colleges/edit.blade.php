    ...
    <div class="flex flex-wrap">
        <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
            ...
            <ol class="list-none p-0 inline-flex">
                ...
                <li>
                <a class="text-gray-500" aria-current="page">Edit Perguruan Tinggi</a>
                </li>
            </ol>
            </div>
                ...
                <input type="hidden" name="id" value="{{$college->id}}" />
                    <div class="pb-2">
                        ...
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" name="name" type="text" required="" placeholder="Your Name" aria-label="Name" value="{{ $college->name }}">
                    </div>
                    <div class="pb-2">
