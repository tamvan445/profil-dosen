    ...
    <div class="flex flex-wrap">
        <div class="w-full my-6 pr-0 lg:pr-2">
            <p class="text-xl pb-6 flex items-center">
                <i class="fas fa-list mr-3"></i> Form Perguruan Tinggi
            </p>
            ...
            <ol class="list-none p-0 inline-flex">
                ...
                <li>
                <a class="text-gray-500" aria-current="page">Form Perguruan Tinggi</a>
                </li>
            </ol>
            </div>
            <div class="pt-1 p-1">
                <form class="p-10 bg-white rounded shadow-xl " method="POST" action="{{ route('colleges.store') }}" enctype="multipart/form-data">
                @csrf
                    <div class="pb-2 max-w-xs">
                        <label class="block text-sm text-gray-600" for="name">Perguruan Tinggi *</label>
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" name="name" type="text" required="" placeholder="Perguruan Tinggi" >
                    </div>
                    @error('name')
                    <div class="pt-1">
