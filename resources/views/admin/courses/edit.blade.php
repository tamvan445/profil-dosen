            ...
            <div class="pt-1 p-1">
                ...
                <input type="hidden" name="id" value="{{$course->id}}" />
                    <div class="pb-2 max-w-xs">
                        ...
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" name="course_code" value="{{ $course->course_code }}" type="text" required="" aria-label="Name">
                    </div>
                    <div class="pb-2 max-w-xs">
                        <label class="block text-sm text-gray-600" for="course">Mata Kuliah *</label>
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" name="course" value="{{ $course->course }}" type="text" required="" aria-label="Name">
                    </div>
                    <div class="mt-2">
                    <div class="pb-5">
