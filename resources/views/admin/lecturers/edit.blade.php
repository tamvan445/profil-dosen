...
<div class="container">
    <div class="row">
    <div class="col-sm-6">
<p style="font-size: 20px;">Ubah Data Dosen</p>
</div>
<div class="col-sm-6">
...
<div class="col-md-6 offset-md-3">
    <form method="POST" action="{{ route('lecturers.update') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="studyProgram" value="{{ $lecturer->studyProgram }}">
    </div>
    <div class="form-group">
