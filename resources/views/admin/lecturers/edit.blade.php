    ...
    <div class="flex flex-wrap">
        <div class="w-full my-6 pr-0 lg:pr-2">
            <p class="text-xl pb-6 flex items-center">
                <i class="fas fa-list mr-3"></i> Ubah Data Dosen
            </p>
            ...
            <div class="pt-1 p-1">
                <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{ route('lecturers.update') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $lecturer->id }}" />
                    <div class="pb-2 max-w-xs">
                        <label class="block text-sm text-gray-600" for="name">Nama *</label>
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" type="text" class="form-control" name="name" value="{{ $lecturer->name }}">
                    </div>
                    @error('name')
                    <div class="pb-1 pt-1">
                    ...
                    <div class="pb-2 max-w-xs">
                        ...
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" type="text" class="form-control" name="nidn" value="{{ $lecturer->nidn }}">
                    </div>
                    @error('nidn')
                    <div class="pb-1 pt-1">
                        <div class="w-60 px-4 py-3 text-xs text-red-500 border border-red-500 rounded-lg" role="alert">
                    ...
                    <div class="" x-data="imageData()">
                        ...
                        <p class="text-center uppercase text-bold">
                            ...
                            <input type="file" name="lecturer_photo" id="thumbnail" class="hidden" @change="updatePreview()">
                        </p>
                        </div>
                        <div x-show="previewUrl !== ''">
                    ...
                    @enderror
                    <div class="pb-2">
                    <label class="block text-sm text-gray-600" for="college_id">Perguruan Tinggi *</label>
                    ...
                    @enderror
                    <div class="pb-2 max-w-xs">
                        <label class="block text-sm text-gray-600" for="study_program">Program Studi *</label>
                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" type="text" class="form-control" name="study_program" value="{{ $lecturer->study_program }}">
                    </div>
                    @error('study_program')
                    <div class="pb-1 pt-1">
                        <div class="w-60 px-4 py-3 text-xs text-red-500 border border-red-500 rounded-lg" role="alert">
                    ...
                    @enderror
                    <div class="pb-2">
                    <label class="block text-sm text-gray-600" for="last_education">Pendidikan Terakhir *</label>
                    <svg class="w-2 h-2 absolute right-0 m-4 pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 412 232"><path d="M206 171.144L42.678 7.822c-9.763-9.763-25.592-9.763-35.355 0-9.763 9.764-9.763 25.592 0 35.355l181 181c4.88 4.882 11.279 7.323 17.677 7.323s12.796-2.441 17.678-7.322l181-181c9.763-9.764 9.763-25.592 0-35.355-9.763-9.763-25.592-9.763-35.355 0L206 171.144z" fill="#648299" fill-rule="nonzero"/></svg>
                    <select name="last_education" class="w-80 border border-gray-300 text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
